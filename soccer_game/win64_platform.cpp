...
#include "platform_unspecific.cpp" 
...
int WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR  lpCmdLine,  int nShowCmd
	...
	HWND window = CreateWindow(window_class.lpszClassName, L"Gameee!", WS_OVERLAPPEDWINDOW|WS_VISIBLE, CW_USEDEFAULT, CW_USEDEFAULT,1280,720,0,0,hInstance,0);
